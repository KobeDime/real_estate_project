...
if (isset($_REQUEST['reg'])) {
	...
	if ($num == 1) {
		...
		if (!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage)) {
			...
			if ($result) {
				$msg = "<p class='alert alert-success'>Register Successfully! Proceed to Login Page</p> ";
			} else {
...
<head>
	...
	<title>KobEstate - Register</title>
</head>
							...
							<div class="login-right">
								<div class="login-right-wrap">
									...
									<form method="post" enctype="multipart/form-data">
										...
										<button class="btn btn-success" name="reg" value="Register" type="submit" style="margin-left: 33%;">Register</button>
									</form>
									<div class="login-or">
