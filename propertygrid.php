...
<head>
    ...
    <title>Kobe Estate - Property Grid</title>
</head>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                if (isset($_REQUEST['filter'])) {
                                    ...
                                    //SELECT * FROM `property` WHERE type='office' or type='office' and stype='sale' or stype='rent' and city='valsad' OR state='manila'
                                    //SELECT * FROM `property` WHERE type='office' and stype='sale'  and city='valsad' OR state='manila'
