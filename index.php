...
<body>
    <div id="page-wrapper">
        <div class="row">
            ...
            <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('new_images/banner.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-lg-12">
                            <div class="text-white">
                                <h1 class="mb-4"><span class="text-success">Welcome to KobEstate:</span><br>
                                    Let Us Lead You to Your Perfect Home</h1>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Property Sales</a></h5>
                                    <p>Streamline your property sales with our expert services. From listing to closing, we ensure a smooth and efficient process.</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    <i class="flaticon-for-rent text-success flat-medium" aria-hidden="true"></i>
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Rental Management</a></h5>
                                    <p>Maximize your rental income with our comprehensive management solutions. We handle everything from tenant placement to maintenance.</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <p>Explore our diverse property listings to find the perfect match for your needs. Detailed descriptions and high-quality photos make it easy to choose.</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    <i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Investment Consulting</a></h5>
                                    <p>Get expert advice on real estate investments. Our team provides valuable insights and strategies to help you make informed decisions and achieve your investment goals.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="full-row">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h2 class="text-secondary double-down-line text-center mb-4">Featured Listings</h2>
                        </div>
                        <div class="col-md-12">
            ...
            <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('new_images/banner2.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="living-list pr-4">
                                <h3 class="pb-4 mb-3 text-white">Why Partner With Us?</h3>
                                <ul>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>Our commitment to excellence has earned us top ratings in the industry. We deliver exceptional results, ensuring your real estate needs are met with the highest standards.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        <i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
                                        <div class="pl-2">
                                            <h5 class="mb-3">Quality You Can Trust</h5>
                                            <p>We pride ourselves on providing high-quality services tailored to your specific needs. Our attention to detail ensures a seamless and satisfying experience from start to finish.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        <i class="flaticon-seller flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
                                        <div class="pl-2">
                                            <h5 class="mb-3">Expert Agents</h5>
                                            <p>Our team of experienced professionals brings a wealth of knowledge and expertise to every transaction. We are dedicated to guiding you through the real estate process with confidence and ease.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="full-row">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-secondary double-down-line text-center mb-5">Our Process</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>We begin by understanding your unique needs through a comprehensive discussion, ensuring we align our goals with your vision.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <h5 class="text-secondary mt-5 mb-4">Detailed Analysis</h5>
                                <p>Our team thoroughly reviews all necessary documents and data to craft a strategy that meets your objectives.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <h5 class="text-secondary mt-5 mb-4">Final Acquisition</h5>
                                <p>After careful planning and analysis, we execute the acquisition, ensuring a smooth and successful transition.</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="full-row overlay-secondary" style="background-image: url('new_images/banner3.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                <div class="container">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="new_images/manila.jpg" alt="manila">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(state), property.* FROM property where city='Manila'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="new_images/qc.jpg" alt="quezonCity">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(state), property.* FROM property where city='Quezon City'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                            <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a></h4>
                                            <span><?php
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="new_images/cebu.jpg" alt="cebuCity">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(state), property.* FROM property where city='Cebu City'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                            <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a></h4>
                                            <span><?php
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="new_images/davao.jpg" alt="davaoCity">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $query = mysqli_query($con, "SELECT count(state), property.* FROM property where city='Davao City'");
                                        while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                            <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a></h4>
                                            <span><?php
