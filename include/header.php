<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
            ...
            <div class="row">
                <div class="col-md-8">
                    <ul class="top-contact list-text-white d-table">
                        <li><a href="https://seankobedime.netlify.app/"><i class="fas fa-globe text-info mr-1"></i> Sean Kobe R. Dime</a></li>
                        <li><a href="#"><i class="fas fa-envelope text-info mr-1"></i> kobe24.dime@gmail.com</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
    ...
    <div class="main-nav secondary-nav hover-success-nav py-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="new_images/blackLogo.png" alt="blackLogo"></a>
